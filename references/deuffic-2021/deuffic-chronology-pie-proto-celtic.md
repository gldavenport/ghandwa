...
short_title: "Chronology PIE to Proto-Celtic"
author: "Maël Deuffic"
year: 2021
source_type: "MA thesis"
institution: "Universiteit Leiden"
supervisor: "Alexander Lubotsky"
second_reader: "Tijmen C. Pronk"
source_file: "deuffic-chronology-sound-changes-pie-proto-celtic.pdf"
package_name: "deuffic-chronology-pie-proto-celtic"
corpus_role:
  - "Proto-Celtic sound-change chronology"
  - "relative chronology model"
  - "Ghandwa daughter-language sound-change comparandum"
extraction_status: "targeted-cleanup-pass"
page_anchors: true
table_outputs:
...
# Deuffic — Chronology PIE to Proto-Celtic

> First-pass Markdown extraction from the uploaded PDF. Page anchors refer to PDF page order, not necessarily the printed thesis page number. Dense linguistic notation has been left close to the source; uncertain extraction artifacts are tracked separately in `notes.md`.
> Targeted cleanup pass applied: corrected obvious `OIr.` OCR artifacts; normalized repeated reconstructed-output asterisks in the final chronology; standardized Deuffic’s `*u̥n` notation where OCR had `*un` or bare `u̥n`; normalized selected `*ei̯e`, `*CLiT`, and `*ē > *ī` notations; and corrected `8,22·10^33` in the mathematical section. The notation `*u̥n` is retained as Deuffic’s source notation and should not be treated as a standard PIE phoneme.
...
The relative chronology of sound changes from Proto-Indo-European
to Proto-Celtic
Deuffic, Maël
...
Citation
Deuffic, M. (2021). The relative chronology of sound changes from Proto-Indo-European to
Proto-Celtic.


Version:             Not Applicable (or Unknown)
                     License to inclusion and publication of a Bachelor or Master thesis in
License:
                     the Leiden University Student Repository
Downloaded from:     https://hdl.handle.net/1887/3213061
...
The relative chronology of sound
changes from Proto-Indo-European to
             Proto-Celtic

                     Maël Deuffic

                       s2922975
 MA thesis in Comparative Indo-European Linguistics



          Supervisor: Prof.dr. Alexander Lubotsky
            Second reader: Dr. Tijmen C. Pronk
...
## Table of contents
     Abbreviations ................................................................................................................. 3
     Introduction .................................................................................................................... 5
     I.    Proto-Celtic sound changes ..................................................................................... 7
          1.          Laryngeals ........................................................................................................ 7
#### 1.1.      *HV > *V ..................................................................................................... 7
#### 1.2.      *CHV > *CV ................................................................................................ 8
#### 1.3.      *VH > *V̄(H) ................................................................................................ 8
...
#### 1.5.      *#HC > *#C ................................................................................................ 11
#### 1.6.      *CHC > *CaC, *CC ................................................................................... 11
#### 1.7.      *CRHC > CRāC, CRăC ............................................................................. 12
#### 1.8.      *V̄CV́ > *V̆CV́ (Dybo’s law) and *CHIC > *CĪC, CĬC ............................ 14
          2.          Stops ............................................................................................................... 15
#### 2.1.      *TK > *KT ................................................................................................. 15
#### 2.2.      *T[dental]T[dental] > *tst ................................................................................... 16
#### 2.3.      *Ḱ > *K ...................................................................................................... 17
#### 2.4.      *RDC- > *RaDC ........................................................................................ 17
#### 2.5.      *gw > *b ...................................................................................................... 18
#### 2.6.      *Dh > D ....................................................................................................... 19
#### 2.7.      *pe(R)kw > *kwe(R)kw ................................................................................ 24
#### 2.8.      *T[labial/velar]t/s > *χt/s .................................................................................. 27
#### 2.9.      *-pL- > *-bL- .............................................................................................. 29
#### 2.10. *pn > *u̥n .................................................................................................. 29
#### 2.11. *p > (φ) > Ø .............................................................................................. 30
          3.          Fricative *s ..................................................................................................... 33
#### 3.1.      *-sl/n/m- > *-ll- / *-nn- / *-mm-................................................................. 33
#### 3.2.      The clusters *#sr- and *-sr- ........................................................................ 33
          4.          Resonants ....................................................................................................... 35
#### 4.1.      *CLT > *CLiT ............................................................................................ 35
#### 4.2.      *R̥ > *aR ..................................................................................................... 35
#### 4.3.      *mu̯ > *u̯ ..................................................................................................... 36
...
#### 5.7.      *eu̥ > *ou̥ .................................................................................................... 43
#### 5.8.      *uu̥ > *ou̥ .................................................................................................... 44
II. A relative chronology .............................................................................................. 45
   A mathematical approach of the notion of relative chronology ............................... 47
Conclusion ................................................................................................................... 49
Bibliography ................................................................................................................ 50
...
-   for example, *CL̥T > *CL̯iT before *R̥ > *aR̯, AND L̯ does not belong to the category
...
##### 1.1.2.    *Ho > *o
       *h1orb - > OIr. orb ‘patrimony, heir’. Cf. Lat. orbus ‘orphan’, Gr. ὀρφανός.
               h
...
##### 1.1.3.   Hi, Hu > i, u
        *h2i-n-d - > MW. ennynnu ‘lightning’. Cf. Gr. αἴθω ‘burn’ where the laryngeal betrays
                  h
...
2
  Zair (2012), p. 19.
3
  Matasović (2009), s.v. *ekwo-.
4
  Delamarre (2003), s.v. onno-.
5
  Matasović (2009), s.v. *osno-. Two examples are given here since for *h3erg-, the type of the laryngeal is
deduced from Celtic data and Hittite only proves the presence of the laryngeal.
6
  Matasović (2009), s.v. *samali-, *samalo-. Deshayes (2003) s.v. hañval, for Old Breton.
7
  Zair (2012), p. 21.
8
  Matasović (2009), s.v. *akro-.
9
  Zair (2012), p. 26.
...
the total loss of laryngeals. Thus, we have:
    - *ḱl̥ Heto- > *kalHeto > *kaleto- > OIr. calad ‘hard’, MW. MBr. caled, C. cales. The
...
before Dybo’s law.
                   ...
                   1.3.1.2.   *eh2 > *ā(H)
       *b reh2tēr > *brātīr > OIr. bráthir ‘brother’, MW. brawt, OBr. brotr, MBr. breuzr, OC.
            h
...
The word for ‘swan’ can come from both a zero-grade *ǵhh̥2ns- or an e-grade *ǵheh2ns-
...
kravíḥ ‘raw meat’, Gr. κρέας (< *kreuh2s), Lat. cruor (< *kruh2-ōs).20
...
14
   Matasović (2009), s.v. *gansi-.
15
   Zair (2012), p. 110.
16
   de Bernardo Stempel (1987), p. 117.
17
   McCone (1996), p. 52.
18
   Schrijver (1995), p. 182.
19
   McCone (1996), pp. 59-60.
20
   Zair (2012), p. 115.
...
*ē > *ī: *h2weh1nto > wēnto > wīnto > winto-
        *V̄RC > *V̆RC: *h2weh1nto > wēnto > wīnto > winto
        *ō > *ā: *deh3- > *dōno- >*dāno-
        *ei > *ē: *(H)rei̥ d- > *rēd-o- > OIr. réidid ‘rides’
...
valid for *h2-, as Schumacher notices, since there is no clear evidence for *h3.22 The first case
...
21
   McCone (1996), p. 52.
22
   Schumacher (2004), p. 126.
23
   Schrijver (2016), p. 495.
24
   Zair (2012), p. 36.
25
   de Bernardo Stempel (1999), p. 172, fn. 108.
26
   Zair (2012), p. 37.
...
27
     Zair (2012), pp. 48-53.
28
     Zair (2012), pp. 57, 166-167.



<!-- page: 14 -->

Lat. cerebrum < *ḱerasrom < *ḱerh2srom.29 For Zair, such a development is trivial,
30
   but Schrijver notices that it is present mostly in Tocharian, and is very rare in Germanic,
...
will give' > *fibrase- > OIr. ebraid)35, *pn > *u̥n (*dh2p-neh2 > *dapnā > *dawnā > OIr. dúan,
see…)
...
30
   Zair (2012), p. 269.
31
   Schrijver (2016), p. 493.
32
   Matasović (2009), p. 6.
33
   Schrijver, ibid.
34
   Schrijver (1991), pp. 331-333.
35
   Matasović (2009), p. 9.
36
   Cowgill (1970), fn. 30.
37
   Schrijver (1995), p. 168.



<!-- page: 15 -->

Joseph, following Kuryłowicz’s theory on the morphological zero-grade, assumed that
...
as is exemplified by:
    - Lat. glăber ‘smooth’ < *ghl̥ dh-ro-
    - OIr. flaith ‘rule’ < *wl̥ h2-ti- (where *-i- is a consonant)
...
38
   Joseph (1982), p. 56.
39
   de Bernardo Stempel (1987), pp. 40-43.
40
   Schrijver (1991), pp. 417-418.
41
   Isaac (2007), pp. 21-59.
42
   Schrijver (2016), p. 491.



<!-- page: 16 -->

4. other specifically Celtic changes: *gw > *b, *pL > *bL, *eRa > *aRa, *ō(C)# >
ū(C)#, *u̥n > *bn
...
tó- > *sītó- > *sĭtó-). He provides three “good” examples of *CHIC > *CĪC:48
    ...
    - OIr. súil ‘eye (of the sky) = sun’ < *sūli- < *sh2u-l-i-. To be compared with MW. heul
        ‘sun’, MB. heol and Skt. sū́ rya-, Gr. ἠέλιος, Lat. sōl. Here we have the possibility of
...
43
   Dybo (1961).
44
   Kortlandt (1981), pp. 27-28.
45
   Schrijver (2016), p. 491.
46
   Schrijver (1991), p. 343.
47
   ibid., p. 527.
48
   Zair (2012), pp. 119-120, 128.
49
   Loth (1884) s.v. cléd and hin.



<!-- page: 17 -->

Matasović notices, from a a form *sh2wōl- which would give also OIr. súil, but which
...
-   *dhǵh(y)es(i) > Gr. χθές ‘yesterday’, Lat. heri, OHG. gesterēn, OIr. in-dé, MW. doe,
         MBr. dech
...
intermediary form *kþ / *gð, maybe pronounced in Proto-Celtic as [t͜s] and [d͜z].55 However,
...
was pronounced as an affricate [t͜s]. Because of OIr. fo:cress ‘was thrown/put’ < *krisso- <
...
*krts(t)o-, this change must have happened after *CLT > *CLiT,59 otherwise we would expect
...
59
   McCone, ibid.
60
   Matasović (2009), s.v. *karro-.
61
   ibid., p. 6.
62
   McCone (1996), p. 48.
63
   Matasović (2009), p. 6, and ibid. s.v. *frixtu- for OIr. richt.



<!-- page: 20 -->

-*mǵh2 > *mg-lo- > *maglo- > OIr. mál ‘prince’, MW. mael, MBret. -mael. To be
...
64
   Schrijver (1991), pp. 415-416, and (2016), p. 494.
65
   Matasović (2009), s.v. *aglo-.
66
   Schrijver (1991), p. 478.
67
   Matasović (2012), p. 135.
68
   Matasović (2009), p. 11, Zair (2012), p. 65.



<!-- page: 21 -->

-   *gwenh2 > *benā > OIr. bé ‘woman’, ben, OW. ben, MBr. (h)e-ben ‘the other one’, lit.
...
69
   Breton opposes the masculine expression an eil hag e-gile ‘one another’, lit. ‘the male one and his male fellow’
(OBr. kiled ‘fellow’) to the feminine an eil hag he-ben ‘the female one and her female fellow’.
70
   Matasović (2009), s.v. *benā.
71
   ibid., s.v. *biwo-.
72
   McCone (1996), p. 37.
...
treatment in Welsh golchi, Br.G. golc’hein and Br.KT. gwelc’hi, Br.L. gwalc’hi)74, than a
...
75
   Pedersen (1909), p. 96.
76
   Schrijver (1995), p. 131.
77
   Delamarre (2001), s.v. gaiso-.
78
   Cowgill (1980), p. 74.
79
   McCone (1996), pp. 39-40.
80
   Matasović (2009), s.v. *argyo-.
81
   McCone (1996), p. 41.
...
2. *kw, gw(h) > PBrit. *p, b (separation of Proto-Irish and Proto-Brittonic. The labial
...
82
   Schrijver (2016), p. 496.
83
   McCone (1996), pp. 42-43.
84
   Cowgill (1980), pp. 65-66.
85
   Maddieson (1984), p. 112.



<!-- page: 24 -->

however, there seem to be no structural reason for the change *kw’ > b, contrarily to McCone’s
...
##### 2.6.3.     The series of aspirated stops: a link with the Italic branch?
...
voiced stops, in anlaut, turned into fricatives, namely [x/h] and [f] in all Italic languages:87
    ...
    - *gwh > f: *gwher- > Lat. for-ceps
        ...
        Before a liquid, initial *gh remained a velar stop g-: *ghlh2dhro- > Lat. glaber (ON.
...
g after a nasal, and Lat. b, b, v, h after u, l, r.
    ...
    - *-gh- > -h-: *ueǵh-e/o- > Lat. vehō (but *h3minǵh- > Lat. mingo, and *dhiǵh-lo- > *figlo
        > Lat. figulus)
...
be seen in *ghlh2dhro- > *glaðro- > *glaβro > Lat. glaber (instead of *glaþro > *glatro- >
...
87
   Meiser (1998), pp. 101-103.
88
   Schrijver (2016), p. 496. The rule is not clearly exposed in Schrijver’s article and seems to be deduced from
...
hypothesis. If one does not try to prove this hypothesis but is just interested in Celtic
...
-   Lat. quīnque, Osc. púmp- ‘fifth day’, U puntes, OIr. cóic, OW.pimp, OBr. pemp, Gaul.
...
94
   Cowgill (1970), p. 145.
95
   Schrijver (1993), p. 183-184.
96
   Vendryes (1908), pp. 131-132.



<!-- page: 28 -->

in Celtic, a change from *kwu to *ku would have prevented the assimilation. Cowgill
...
97
   Cowgill (1970) p. 113.
98
   Prósper Pérez (2013), p. 11.
99
   Matasović (2009), s.v. *kwerxt-.
100
    Probably a Sabellic form, equivalent to Lat. coquīna ‘art of cookery’ (Apul.). Cf. Steinbauer (1989); De Vaan
(2008), s.v.
101
    Meiser (1998), § 65, 5.
102
...
Moreover, this Hittite word is to be linked with Skt. bahú-, from *dhbhnǵh-eu-,103 not
      ...
      -   *prokw- > Lat. prope ‘near, close’, superlative proximus. Such a pair, according to
          ...
          prem, MBr. preff (Skt. kr̥ ́ mi-, Lith. kirmìs).106 Watkins concludes that the assimilation
...
103
    Kloekhorst (2008), s.v. panku-.
104
    Sihler (1995), p. 145-146.
105
    Ernout, Meillet (1932), s.v. propter.
106
    Thurneysen (1946), p. 137.
107
    Watkins (1966), p. 34.
108
    Dunkel (1980), pp. 101-102.
109
    Cowgill (1970), p. 113.
110
    Jackson (1953), pp. 407-411.
111
    Zink (1986), p. 107.
...
The formulation presented by Matasović is too general and vague: “*C1C2 > *xC2
...
-*h2ēǵ-s-t > *h2aχst > *aχt > OIr. ‘drove’, W. aeth ‘went’. See Skt. ájati ‘drive’, Gr.
       ἄγω, Lat. agō.119
...
concerned by this change since *pN became *u̥n (see 2.10.) after a back vowel.
    - *pi-prh3-se- > *pibrase- > *fibrase- > OIr. ebraid ‘will bestow, will give’.124
       before p > f
...
formulation we decided to keep, even though it would not be phonetically absurd that *n and
...
128
    Matasović (2009), s.v. *sowno-.
129
    de Bernardo Stempel (1999), p. 255, fn. 136.
130
    Matasović (2009), s.v. *dawnā.
131
    McCone (1996), p. 45.
132
    Maddieson (1984), p. 37.
...
for /w/ or /u/ (unlike Etruscan), but would have the same value as Latin and Faliscan /f/.
...
133
    Eska (1998), Schumacher (2004). In: Isaac (2007), pp. 11-12.
134
    Schrijver (1995), p. 348.
135
    Lubotsky (2006), p. 1007.
136
    McCone (1996), p. 44-45.
137
    Schumacher (2004), pp. 509-510.



<!-- page: 34 -->

For Isaac, it is possible to replace the full grade of the suffix *-ent- by a zero-grade on
...
Thurneysen and Isaac) because of *h1epi-ro-m > *ei̥ ro- > *ēro- > OIr. íar ‘after’ (and not *ēro-
> *īro- > **ír).140 However he also says that *ē > *ī must predate *ei̥ > *ē because of *(H)rei̥ d-
> PCelt. *rēd-o- 'ride' > OIr. réidid (and not *rīd-o- > **rídid),141 so in any case it is impossible
that *ei̥ ro- > *ēro- becomes *īro-. The diphthongization of PC. *ē (from PIE. *-ei̥ -) to OIr. -
ía- is perfectly regular (*wei̥ dos > *wēdos > OIr. fíad ‘in the presence of’, to compare with Gr.
...
only proves the following chronology:
          ...
          2. *p > Ø
      -   *h1epirom > *ei̥ rom > *ērom, OIr. íar shows that *p > Ø predates *ei̥ > *ē.143
...
141
    ibid., p. 9.
142
    Pedersen (1909), pp. 58-59. Thurneysen (1946), p. 36.
143
    In terms of combinatorics, the development of *h1epirom (1. > 3.) is unnecessary to establish a totally ordered
...
-   *peperh3e > *ēre > OIr. ír shows that *p > Ø predates *ē > *ī.
          3. *ē > *ī
      -   *(H)rei̥ d- > PCelt. *rēd-o- 'ride' > OIr. réidid shows that *ē > *ī predates *ei̥ > *ē.
          4. *ei̥ > *ē
...
*smeḱru- (Hit. zamankur, Skt. śmáśru-), OIr. snaïd ‘swim’ < *sneh2- (Skt. snā́ ti).
...
144
    McCone (1996), pp. 45-46.
145
    Meiser (1998), p. 118.
146
    McCone (1996), p. 46.
147
    Schrijver (1995), p. 448, (2016), p. 494.
148
    Delamarre (2003), s.v. tri-, treis, tidres, 'trois'



<!-- page: 36 -->

‘stream, flow’, W. ffrwd. Both changes would be Italo-Celtic (*srīgos > *θrīgos > Lat. frīgus
‘cold).149
...
if *r is palatal, otherwise, those clusters only develop into OIr. -ér-:
     ...
     - *k etesōr > *kwetēsūr-es (coll/nom. pl) > OIr. cethéoir
            w
...
**pedoer Br. **touer, **pedoar or **pedor because *ehī would have become *ē ̣ and then a
...
149
    Schrijver (2016), p. 494.
150
    Schrijver (1995), pp. 451-442.
151
    ibid., pp. 388-389.
152
    McCone (1996), pp. 47-48.
153
    Thurneysen (1925), p. 380-381.
154
    Matasović (2009), s.v. *sfrawo-.
155
    ibid., s.v. *sfraxto-.
156
    ibid., s.v. *sfrusso-.
...
Those examples could simply show that *sr- became *fr- in British after the loss of *p,
...
an early split of Proto-Goedelic from the rest of Proto-Celtic, however for McCone, OIr. -e-
...
simply considered as a consonant, this sequence simply falling in the type *R̥C.
  ...
  ̄
*Vs, as the development of acc. sg. *reǵ-ns proves it: *reǵ-ns > reg-ans > rīg-ās > OIr. ríga.
...
162
    Isaac (2007), p. 15.
163
    De Bernardo Stempel (1990), pp. 31-2, 35.
164
    McCone (1996), pp. 48-49.



<!-- page: 39 -->

*kou̯irjo/ā > Volscan couehriu, Lat. cūria.165 One can notice however that the number of
...
#### 4.5.     *i̯e > *i, *ei̯e > *ē > *ī
       For the rule *i̯ e > *i we can find:
    - *gab-i̯ e > *gabi > Gaul. gabi, OIr. gaib ‘take!’171, presented by McCone as i-presents,
...
(*VHC > *V̄C) because of W. cno-(af) ‘bite, gnaw’ < *knāiti < *knāi̯ eti < *knah2i̯ eti, where
...
from the regular development of *CRHC > *CRāC: *knh2-i̯ e-ti > *knāi̯ eti > *knāiti. Except
...
166
    McCone (1996), p. 49.
167
    Matasović (2009), s.v. *awon-tīr.
168
    McCone (1992), p. 103-106.
169
    Matasović (2009), s.v. *obnu-.
170
    McCone (1996), p. 49.
171
    ibid.
172
    Kortlandt (2007), p. 137.
173
    Isaac (2007), p. 68.
174
    ibid. pp. 69-70.
...
merely a terminus ante quem.175 Furthermore, if Isaac’s hypothesis about the simplification of
...
change will not be considered in our final chronology since it cannot be situated.
    ...
    - *sonh-eie-ti > Celtib. uer-zoniti.176
        The change *ei̯e > *ī would have had an intermediary stage *ē, which means that we
...
175
    Isaac (2007), p. 70.
176
    Eska (1989), pp. 116-117.
177
    McCone (2001), p. 486.
178
    Joseph (1982), pp. 35-42.
179
    Schrijver (1995), pp. 77-78.
180
    Matasović (2009), s.v. *elV-.
181
    Schrijver (1995), p. 78-79.
182
    Matasović (2009), p. 8.
...
- *telH-mō(n) > *telamon > *talamon > OIr. talam ‘earth), to be compared with Gr.
...
˙ber is not an orthographical variant of ˙beir, -r- was depalatalized in ˙ber, and ˙cer is analogical
of ˙ber, which, according to him, is much less economical than Joseph’s explanation. He finally
...
187
    ibid., pp. 88-89.
188
    McCone (1996), p. 59. Matasović (2009), s.v. *rīg-.



<!-- page: 42 -->

relative chronology: if this language had undergone *ō(C)# > *ū(C)# (see 5.3.), then it
...
happened before the Osthoff-type shortening *V̄RC > *VRC.193
        The development *(H)reid- > PCelt. *rēd-o- > OIr. réidid ‘rides’ proves that it pedates
...
194
    ibid., p. 9.
195
    Beekes (2011), p. 213. Also for the following case ending reconstructions.
196
    McCone (1996), p. 61.
197
    Beekes (2011), p. 213.
...
supposing that this language tried to maintain the opposition between PC. acc. pl. *-om and
...
202
    ibid., pp. 204-205
203
    De Bernardo Stempel (1993), pp. 40-41.
204
    McCone (1996), p. 60.
...
> *u̯intā > OIr. fet (f.) ‘whistling sound’, to be compared with Lat. uentus ‘wind’, Skt. vā́ ta-,
Lith. vé tra ‘storm’ (with an acute proving the presence of a laryngeal). The problem is that
...
208
    McCone (1986), p. 237.
209
    Kortlandt (1981), p. 46, fn. 13.



<!-- page: 45 -->

-   *deh3- > *dānu- > OIr. dán ‘gift’.
...
sequence *ei̯ e gives *ī (see 4.5.). That law can be seen in:
   - *(H)reid- > *rēd-o- > OIr. réidid ‘he rides’, Gal.Lat. rēda ‘chariot’, uerēdus ‘post
       horse’.210 See OE. rīdan ‘to ride’,211 Lith. riedé ti ‘roll’
...
210
    Matasović (2009), s.v. *rēdo-, *rēd-o-, *ufo-rēdo-.
211
    Kroonen (2010), s.v. *rīdan.
212
    McCone (1996), p. 63.
213
    Matasović (2009), s.v. *dēwo-.
214
    Villar (1995), p. 127.
215
    McCone (1996), pp. 15-16.
216
    Villar (1995), p. 91.
217
    Matasović (2009), s.v. *towtā.
218
    ibid., s.v. *kowdo-.
...
- *neu-io- > *nouio- > OIr. núae, MW. newydd, Br. nevez, MC. noweth, Gaul. Nouio-.219
...
221
    ibid., s.v. *towtā.
222
    Delamarre (2003), s.v. teuta, touta; leucos; nouiios.
223
    Schrijver (1995), p. 192.
224
    Matasović (2009), s.v. *krū-.
225
    Schrijver (1995), p. 330.
226
    Cowgill (1985), p. 20-25.



<!-- page: 47 -->

## II. A relative chronology
...
*CHC > *CaC: before *pL > *bL, *eRa > *aRa, *pn > *u̥n
...
a.q.          *ei̯e > *ī: before *ē > *ī

#### 3.2.   *R̥ > *aR: before *CHV > *CV, *pn > *u̥n
              *pL > *bL: before *p > Ø
              *gw > *b: before *Dh > *D
a.q.          *Dh > *D
...
## A mathematical approach of the notion of relative chronology
...
our case, 31 elements make 8,22·10^33 combinations. At that stage, no relative
...
unfeasible for a human), their number is still tremendously huge. It seems to be quite an
...
## Bibliography
ALBB: Le Roux, P. (1927) Atlas Linguistique de Basse-Bretagne. Paris: Librairie E. Droz.

BEEKES, R. S. P. (2011) Comparative Indo-European Linguistics: An Introduction. Revised
and corrected by Michiel de Vaan. Amsterdam/Philadelphia: John Benjamins Publishing
Company.

DE BERNARDO STEMPEL, P. (1987) Die Vertretung der indo-germanischen liquiden und nasalen
Sonanten im Keltischen. Innsbruck: Innsbrucker Beiträge zur Sprachwissenschaft.
— (1990) "Einige Beobachtungen zu indogermanischem /w/ im Keltischen", in: Ann T. E.
Matonis, Daniel Frederick Melia, Celtic language, Celtic culture. Festschrift for Eric P. Hamp,
Van Nuys: Ford & Bailie.
— (1993) ‘Probleme der relativen Chronologie: nochmals zu idg. *ō im Keltischen',
