# Extraction Notes: The Venetic Names of Roman Siscia

- Original PDF: `prósper-venetic-names-roman-siscia.pdf`
- Markdown: `prosper-venetic-names-roman-siscia.md`
- Companion form list: `prosper-venetic-names-roman-siscia-forms.tsv`
- Pages in source PDF: 22
- Article/body extraction began at PDF page: 1
- Text blocks processed: 94
- Blocks dropped as running headers/footers/layout noise: 2
- Markdown paragraph/block count: 91
...
Born-digital PDF; text extraction preserves most technical notation.
