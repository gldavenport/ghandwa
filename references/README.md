...
| `ONOM` | Onomastics — personal name, divine name, ethnic name, or place name formation patterns usable in building a Ghandwa onomastic register |
| `CORP` | Corpus / inscription — models inscription types, formulaic registers, or pragmatic text patterns usable in composing Ghandwa corpus texts |
