...
<!-- pdf-page: 1066; source-page: 1026 -->
# Envoi
...
a. prepositional marking of direct objects (see §6.1.1.1.2) b. double ethical datives (see §6.1.1.2.5) c. definite article enclisis (see §6.1.2.2.1) d. double determination (see §6.1.2.3) e. impersonals of internal disposition (see §7.8.2.2.5.1) f. narrative imperatives (see §7.8.2.2.8). g. the development of evidentials (see §6.2.5) h. the expansion of ‘have’ and ‘want’ as auxiliaries (see §6.2.3 and §6.2.4) i. the replacement of infinitives with analytic subjunctives (see §7.7.2.1.5)
...
1 In a small way, we hope too that our graphological nativization of sprachbund, i.e., with a lower-case initial letter and a plural in -s, also finds general acceptance.
