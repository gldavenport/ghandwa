# Extraction Notes: Language Change at the Crossroads: What Celtic, What Venetic, and What Else in the Personal Names of Emona?

- Original PDF: `prósper-language-change-crossroads.pdf`
- Markdown: `prosper-language-change-crossroads.md`
- Companion form list: `prosper-language-change-crossroads-forms.tsv`
- Pages in source PDF: 41
- Article/body extraction began at PDF page: 1
- Text blocks processed: 262
- Blocks dropped as running headers/footers/layout noise: 80
- Markdown paragraph/block count: 179
