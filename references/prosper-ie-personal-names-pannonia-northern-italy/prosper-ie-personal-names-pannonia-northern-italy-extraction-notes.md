# Extraction Notes: The Indo-European Personal Names of Pannonia, Noricum and Northern Italy: Comparative and Superlative Forms in Celtic, Venetic, and South-Picene

- Original PDF: `prósper-ie-personal-names-pannonia-northern-italy.pdf`
- Markdown: `prosper-ie-personal-names-pannonia-northern-italy.md`
- Companion form list: `prosper-ie-personal-names-pannonia-northern-italy-forms.tsv`
- Pages in source PDF: 31
- Article/body extraction began at PDF page: 1
- Text blocks processed: 245
- Blocks dropped as running headers/footers/layout noise: 61
- Markdown paragraph/block count: 181
...
Born-digital PDF; one or more custom-glyph technical signs may remain explicitly marked.

Anomaly scan after cleanup:
- unclear glyph markers: 1
