"""
Neo-Wékʷos historical pipeline.

Status: PROVISIONAL. The Neo-Wékʷos rule list is unstable and likely to change.
All test cases for this pipeline should be marked provisional.

Neo-Wékʷos is downstream of Old Wékʷos. Its input token stream comes from
the final output of the Old Wékʷos pipeline (pipeline chaining via pipeline.py).
